                    ...
                    >
                        ...
                        <div className="form-control sm:col-span-2">
                            <input
                                ...
                                className="input input-bordered bg-gray-700 dark:bg-gray-800 text-white"
                                name="cover"
                                required
                            />
                        </div>
                        ...
                        <div className="form-control">
                            <select
                                className="select input-bordered bg-gray-700 dark:bg-gray-800 text-white"
                                name="genre"
                                required
                            >
                        ...
                        <div className="form-control sm:col-span-2">
                            ...
                            ></textarea>
                            {reviewError && (
                                <small className="text-red-400">{reviewError}</small>
                            )}
                        </div>

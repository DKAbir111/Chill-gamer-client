...
const Blog = () => {
    ...
    return (
        <div className="bg-gray-900 py-16 px-3 md:px-8">
                ...
                <div className="space-y-16">
                    {articles.map((article, index) => (
                        <div key={article.id} data-aos="fade-up">
                            <div
                                className={`flex flex-col lg:flex-row mb-12 rounded-lg bg-gray-800 overflow-hidden shadow-lg transition-all duration-500 ${index % 2 === 0 ? 'lg:flex-row-reverse' : ''
                                    }`}
                            >
                                {/* Content Section */}
                                <div className="w-full lg:w-1/2 p-4 md:p-8 lg:pr-16 flex flex-col justify-between">
                                    ...
                                    <p className="text-gray-300 text-lg mb-6">{article.description}</p>
                                    ...
                                    <div className="mt-8 space-y-4">
                                        <div>
                                            ...
                                            <p className="text-gray-300 text-lg">{article.pros.join(", ")}</p>
                                        </div>
                                        <div>
                                            <h5 className="text-pink-400 text-xl font-semibold">What Could Be Improved:</h5>
                                            <p className="text-gray-300 text-lg">{article.cons.join(", ")}</p>
                                        </div>
                                    </div>
                            ...
                            <p className="text-gray-300 text-lg mb-6">{article.content}</p>

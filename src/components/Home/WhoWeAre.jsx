...
export default function WhoWeAre() {
    return (
        <div className="bg-gradient-to-t from-gray-900 to-black min-h-screen flex flex-col justify-center items-center pb-20">
            <h4 className="text-pink-500 font-bold text-sm uppercase mb-2 w-11/12 md:w-10/12 lg:w-11/12 gap-5 mx-auto p-5 self-start">
                Who We Are
            </h4>
            <div className="w-11/12 md:w-10/12 lg:w-11/12 gap-5 mx-auto p-5 rounded-lg flex flex-col lg:flex-row justify-between items-center relative bg-gradient-to-t from-gray-900 to-black">

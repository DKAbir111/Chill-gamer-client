    ...
    return (
        <div className="relative h-[550px]">
            ...
            <div className="relative z-10 flex flex-col justify-center h-full bg-black bg-opacity-60 text-white items-center">
                <div className="w-1/2 mx-auto border p-10 rounded-lg backdrop-blur-sm bg-transparent flex justify-center flex-col items-center bg-gray-400 bg-opacity-10 dark:bg-black dark:bg-opacity-30">

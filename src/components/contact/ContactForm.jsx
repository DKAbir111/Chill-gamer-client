            ...
            >
                ...
                <div data-aos="fade-right">
                    ...
                    <h1 className="text-4xl font-bold leading-tight my-4">
                        Connect with <span className="text-pink-500">ChilGam</span>,
                        <br />
                        Elevate Your Gaming Experience.
                    </h1>
                    <p className="text-gray-400 my-4">
                        Have questions, feedback, or partnership ideas for ChilGam? We&apos;re here
                        to listen. Drop us a message and be part of the ultimate gaming
                        review community.
                    </p>
